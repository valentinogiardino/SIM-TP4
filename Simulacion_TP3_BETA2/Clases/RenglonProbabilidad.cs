...
{
    //Clase que representa un renglon de una tabla de probabilidad
    public class RenglonProbabilidad
    {
        ...
        public RenglonProbabilidad(double cantidad, double probabilidad, double probabilidadAc, double desde, double hasta)
        {
        ...
        public RenglonProbabilidad(double cantidad, double probabilidad)
        {
            this.Cantidad = cantidad;
            this.Probabilidad = probabilidad;
        }
